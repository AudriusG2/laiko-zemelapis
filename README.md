...
- **Žemėlapiai iš Allmaps.** Kai pasirenki vietą, programėlė [Allmaps](https://allmaps.org/) duomenų bazėje ieško išsamių (ne didesnių nei Airijos sala) georeferencijuotų žemėlapių iš įvairių bibliotekų (David Rumsey, Škotijos nacionalinė biblioteka, Stanfordas, Leidenas ir kt.), dengiančių tą tašką. Tikrinama iki 30 išsamiausių; žemėlapiai be datos, tušti ar blogai georeferencijuoti praleidžiami. Tinkami įdedami į laiko juostą su metais, biblioteka ir nuoroda į originalą. Rezultatai savaitę saugomi naršyklėje.
- **NLS lapai.** Didžiojoje Britanijoje ir Airijoje sąraše „Kas čia buvo“ rodomi Škotijos nacionalinės bibliotekos skenuoti lapai, dengiantys tavo vietą (OS 6 ir 1 colio, karo meto, vokiečių jūrlapiai ir kt.), su nuoroda į skeną: iš kiekvienos serijos iki 4 lapų, išdėstytų per jos metus. Visi lapai – per nuorodą „NLS paieška“.
- **Daugiau paieškos.** Nuorodos į OldMapsOnline ir jo istorinius regionus atsidaro jau nukreiptos į tavo vietą ir pasirinktus metus, NLS žemėlapių paieška (Didžiojoje Britanijoje ir Airijoje) – į tavo vietą, o nuoroda į Allmaps veda į pagrindinį Allmaps puslapį.
...
- **Garsūs žemėlapiai.** 83 svarbiausi istorijos žemėlapiai nuo Pavlovo mamuto ilties iki Google Maps ir šiuolaikinių Worldmapper kartogramų, tarp jų 18 Airijos žemėlapių, „Įdomybių knygos“ pasaulio žemėlapis, 1920 m. National Geographic Europos žemėlapis ir Worldmapper kartogramos (Lietuvos, JK ir Airijos gyventojai, emigracija iš Lietuvos): data, aprašymas lietuviškai, vaizdas ir vieta žemėlapyje.
...
- **Svetainėje** rodomi tik atvirai licencijuoti, nekomercinei naudai leidžiami (CC BY-NC) arba viešosios nuosavybės senieji žemėlapiai (9 nuolatiniai sluoksniai ir tokios pat licencijos Allmaps žemėlapiai; David Rumsey – tik išleisti iki 1929 m., Škotijos nacionalinės bibliotekos partnerių skenai, kuriems reikia leidimo, – tik kompiuteryje).
